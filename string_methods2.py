...
string11 = "  python"
# Your code here
print("[" + string11.lstrip() + "]") #[] show spaces beginning and end of string

# TODO: Use the rstrip() method to remove trailing characters (spaces by default)
# Example: Remove trailing spaces from "python  "
string12 = "python  "
# Your code here
print("[" + string12.rstrip() + "]")  #[] show spaces beginning and end of string
...
string17 = "  python  "
# Your code here
print("[" + string17.strip(" ") + "]") #[] show spaces beginning and end of string
